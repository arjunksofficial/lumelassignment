...
func (_mock *MockStore) BulkCreate(customers []models.Product) error {
...
func (_c *MockStore_BulkCreate_Call) Run(run func(customers []models.Product)) *MockStore_BulkCreate_Call {
...
func (_c *MockStore_BulkCreate_Call) RunAndReturn(run func(customers []models.Product) error) *MockStore_BulkCreate_Call {
	_c.Call.Return(run)
	return _c
}

// BulkCreateOrUpdate provides a mock function for the type MockStore
func (_mock *MockStore) BulkCreateOrUpdate(customers []models.Product) error {
	ret := _mock.Called(customers)
...
func (_c *MockStore_BulkCreateOrUpdate_Call) Run(run func(customers []models.Product)) *MockStore_BulkCreateOrUpdate_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 []models.Product
		if args[0] != nil {
			arg0 = args[0].([]models.Product)
...
func (_c *MockStore_BulkCreateOrUpdate_Call) RunAndReturn(run func(customers []models.Product) error) *MockStore_BulkCreateOrUpdate_Call {
	_c.Call.Return(run)
	return _c
}
